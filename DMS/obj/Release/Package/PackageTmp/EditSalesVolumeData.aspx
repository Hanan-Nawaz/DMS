<%@ Page Title="" Language="C#" MasterPageFile="~/DMS.Master" AutoEventWireup="true" CodeBehind="EditSalesVolumeData.aspx.cs" Inherits="DMS.EditSalesVolumeData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     ...
     <title>Edit Sales Volume Data - DMS</title>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <center>
                                <label style="color: blue; font-size: 20px; user-select: none;"><i class="fas fa-pencil"></i>Edit Sales Volume Data</label>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <asp:TextBox CssClass="form-control" ID="tb_SD_date" TextMode="Date" runat="server" TabIndex="5" placeholder="" required="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mt-5">
                        <div class="col-4 mx-auto">
                            <center>
                                <div class="form-group">
                                    <asp:Button class="btn btn-primary btn-block btn-lg" ID="btn_SD_Calculate" runat="server" TabIndex="7" Text="Analyze" OnClick="btn_SD_Calculate_Click" />
                                </div>
                            </center>
                        </div>
                        ...
                        <div class="col-4 mx-auto">
                            <center>
                                <div class="form-group">
                                    <asp:Button class="btn btn-primary btn-block btn-lg" ID="btn_Save_toDB" runat="server" TabIndex="8" Text="Save to DB" OnClick="btn_Save_toDB_Click" />
                                </div>
                            </center>
                        </div>
